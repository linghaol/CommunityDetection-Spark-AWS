...
## How to use it
   ...
   - Create a cluster in AWS EMR. </br>
     ...
     - Step type : `Spark application` </br>
       ...
       Spark-submit options : `--driver-memory 10g --executor-memory 5g` </br>
     ...
     - Instance type : `m1.xlarge` </br>
       ...
       (You can use other type and number of instances, but make sure that your total memory is larger than 66G, which was observed as the maximum memory used during the process.)
